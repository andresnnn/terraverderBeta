<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    class Pdfc extends FPDF {
        ...
        public function Header(){
            ...
            $this->Cell(30);
            $this->Cell(120,10,'Listado General de Tareas Completas',0,0,'C');
            $this->Ln('10');
            $this->SetFont('Arial','I',8);
            $this->Cell(30);
            $this->Cell(120,10,'Este PDF lista todas las tareas del vivero que estan completas ordenadas por la fecha de creacion.',0,0,'C');
            $this->Ln('5');
            $hoy = getdate();
            $d = $hoy[mday];
            $m = $hoy[mon];
