...
<!--CAMPOS OCULTOS DATOS DE LA PLANTA SELECCIONADA-->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                             <div class="box">
                                ...
                                <div class="box-body">
            <?php echo form_open('user/umbraculos_pla/agregar_planta_umbraculo'); ?>
            <div class="box-body">
            ...
            <div class="box-footer" style="text-align: center;">
                ...
                <a href="<?php echo site_url('user/umbraculos_pla/ver/'.$id); ?>" class="btn btn-default btn-flat">Cancelar</a>
            </div>  
            <?php echo form_close(); ?>
                         </div>
                    </div>
