                            ...
                            <div class="box">
                                    ...
                                    <!-- CONTENIDO -->
                                        <div class="box-header with-border">
                                            <h3 class="box-title"><?php echo anchor('user/tareas_pla/selecciona_umbraculo', '<i class="fa fa-plus"></i> '. 'Crear nueva tarea', array('class' => 'btn btn-block btn-primary btn-flat')); ?></h3>
                                        </div>
                                            <div class="box-body">
