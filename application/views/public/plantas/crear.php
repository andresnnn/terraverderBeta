                        ...
                        <div class="col-md-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Agregar Planta</h3>
                                </div>
                                <div class="box-body">
                                    <!-- CONTENIDO -->
                                    <?php echo form_open('user/plantas_pla/crear'); ?>
                                        <div class="box-body">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <?php echo anchor('user/especies_pla/crear', '<i class="fa fa-plus"></i> ', array('class' => 'btn btn-block btn-primary btn-flat','title' => 'Registrar nueva especie')); ?>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="unidadEspacioPlanta_m2" class="control-label"><span class="text-danger">*</span>Unidades Espacio cm<sup>2</sup></label>
                                                    <div class="form-group">
                                                        <input type="number" name="unidadEspacioPlanta_m2" value="<?php echo $this->input->post('unidadEspacioPlanta_m2'); ?>" class="form-control" id="unidadEspacioPlanta_m2" />
