                            ...
                            <div class="box">
                                ...
                                <div class="box-body">
                                    ...
                                    <?php if ($permisos['idGrupo'] == 3) { ?>
                                            ...
                                            <p>Puede consultar el manual de usuario para cualquier duda que pueda surgir. <a target="_blank" href="<?php echo base_url('upload/manual_especialista1.pdf'); ?>">Haciendo click aquí</a></p>
                                    <?php }?>
                                    ...
                                    <?php if ($permisos['idGrupo'] == 2) { ?>
                                            ...
                                            <p>Puede consultar el manual de usuario para cualquier duda que pueda surgir. <a target="_blank" href="<?php echo base_url('upload/manual_planificador1.pdf'); ?>">Haciendo click aquí</a></p>
                                    <?php }?>
