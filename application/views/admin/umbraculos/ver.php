                                        ...
                                        <table class="table table-striped table-hover">
                                            ...
                                            <div>
                                                <table>
                                                    ...
                                                    <td><h3 title="Presiona para generar un PDF con las tareas del umbraculo." class="box-title"><?php echo anchor('common/tareas/generaPDFUmbraculo/'.$id, '<i class="fa fa-file-pdf-o"></i> '.'PDF Tareas del Umbraculo', array('class' => 'btn btn-block btn-danger btn-flat')); ?></h3></td>
                                                </table>
                                            </div>
                                </div>
                            </div>
